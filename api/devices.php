<?php
    ...
    require_once __ROOT__.'/Back-end/MaterielController.php' ;
    ...
    switch($_SERVER['REQUEST_METHOD']) {
        ...
        case 'GET':
            ...
            // On renvois les informations correspondant à la liste des appareils
            echo MaterielController::GetAllMateriels();
