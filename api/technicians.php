<?php
    ...
    require_once __ROOT__.'/Back-end/UtilisateurController.php' ;
    ...
    switch($_SERVER['REQUEST_METHOD']) {
        ...
        case 'GET':
            ...
            // On renvois les informations correspondant à la liste des techniciens
            echo UtilisateurController::GetAllTechniciens();
